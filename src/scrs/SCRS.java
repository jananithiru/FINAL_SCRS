...
public interface SCRS {
	 ...
	 * @return Return true if the operation is successfully, false otherwise
	 */
	boolean adminAddClass(ShibbolethAuth.Token token, int courseID, String courseName, int courseCredits, int capacity, String term, String instructor, String firstDay,
