...
public class InsertIntoStudent {
	public static void insertShibbolethauth(int id, String X500Account, String X500Password, int userId, String userType){
			...
			// STUDENT
//			String sqlStudent01 = "INSERT INTO STUDENT (ID, FIRSTNAME, LASTNAME, DATEOFBIRTH,TYPE,GENDER,ADVISOR,CREDITS,DEPARTMENT) "
//					+ "VALUES (888, 'Alice1', 'Liddell',  09/01/2014 ,'Master', 'Female', 'Mad Hatter', 1, 'CS');";
	...
	public static void insertStudent(int id,String firstName, String lastName, String dateofBirth, String type, String gender, String advisor, int credits, String department){
