...
//					+ "VALUES (2, 'Alice2', 'Liddell2',  03/10/2000 ,'BS', 22, 'Computer Science');";
...
//					+ "VALUES (3, 'Alice3', 'Liddell3',  04/09/1998 ,'BS', 22, 'Computer Science');";
...
//			stmt.executeUpdate(admin3);
			...
			// COURSE
			String course1 = "INSERT INTO COURSE (ID, NAME,  CREDITS,CAPACITY, FIRSTDAY, LASTDAY, CLASSBEGINTIME, CLASSENDTIME, ROUTINES, LOCATION, TYPE, PREREQUISITE, DESCRIPTION, DEPARTMENT) "
					+ "VALUES (777, '2011', 3, 30, 01/25/2015, 05/30/2015, '08:00', '09:15', 'Tu, Th', 'KH2150', 'Lecture', 'NONE', '2011 Description', 'CS')";
